 ...
 * @author Bubulle
 * 
 * Comparateur de chaines d'attaques se basant sur l'espérance de dégâts
 */
public class ChaineAttVComparator implements Comparator<ChaineAttaquesV>
{
	...
	public int compare(ChaineAttaquesV aO1, ChaineAttaquesV aO2)
	{
		...
		{
			LogFactory.logError("Erreur lors de la comparaison de deux ChaineAttaquesV. Méthode ChaineAttVComparator.compare()");
			return 0;
		}
	}
}