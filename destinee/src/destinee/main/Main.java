...
public class Main
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Début du traitement : résolution d'une attaque (" + nbDAtt + "D+" + bonusAtt + " contre " + nbDDef + "D+" + bonusDef
				+ ", reussite critique ");
		BigDecimal resultat3 = ResolutionAttaque.resoudreAttaque(nbDAtt, bonusAtt, nbDDef, bonusDef, ResolutionAttaque.REOLUTION_COUP_CRITIQUE);
		stopTime = System.currentTimeMillis();
		...
		System.out.println("Début du traitement : résolution d'une attaque (" + nbDAtt + "D+" + bonusAtt + " contre " + nbDDef + "D+" + bonusDef
				+ ", reussite ");
		BigDecimal resultat4 = ResolutionAttaque.resoudreAttaque(nbDAtt, bonusAtt, nbDDef, bonusDef, ResolutionAttaque.REOLUTION_COUP_SIMPLE);
		stopTime = System.currentTimeMillis();
		...
		BigDecimal resultat5 = ResolutionAttaque.resoudreAttaque(nbDAtt, bonusAtt, nbDDef, bonusDef, ResolutionAttaque.REOLUTION_ESQUIVE_SIMPLE);
		stopTime = System.currentTimeMillis();
		...
		System.out.println("Début du traitement : résolution d'une attaque (" + nbDAtt + "D+" + bonusAtt + " contre " + nbDDef + "D+" + bonusDef
				+ ", esquive critique ");
		BigDecimal resultat6 = ResolutionAttaque.resoudreAttaque(nbDAtt, bonusAtt, nbDDef, bonusDef, ResolutionAttaque.REOLUTION_ESQUIVE_PARFAITE);
		stopTime = System.currentTimeMillis();
