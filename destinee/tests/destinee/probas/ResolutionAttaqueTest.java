...
public class ResolutionAttaqueTest extends TestCase
{
	...
	public void testResoudreAtt()
	{
		...
		System.out.println("Attaque : " + att + "D+0; Défense : " + def + "D+0");

		proba1 = ResolutionAttaque.resoudreAttaque(att, 0, def, 0, 1, ResolutionAttaque.RESOLUTION_COUP_CRITIQUE);
		// System.out.println("Proba de faire un coup critique : " + ConversionUtil.bigDecimalVersString(proba1, 10));

		proba2 = ResolutionAttaque.resoudreAttaque(att, 0, def, 0, 1, ResolutionAttaque.RESOLUTION_COUP_SIMPLE);
		// System.out.println("Proba de faire un coup simple : " + ConversionUtil.bigDecimalVersString(proba2, 10));

		System.out.println("Proba de toucher : " + ConversionUtil.bigDecimalVersString(proba1.add(proba2), 10));
	}
}
